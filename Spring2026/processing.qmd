...
- `field_station`: Weather data from Field Station recorded every 15 minutes

- `combined`: Water quality from the `stony_creek` dataset and weather data from the `field_station` dataset in a single dataset

- `daily_combined`: Water quality from the `stony_creek` dataset and weather data from the `field_station` dataset in a single dataset summarized by daily averages

- `weekly_combined`: Water quality from the `stony_creek` dataset and weather data from the `field_station` dataset in a single dataset summairzed by weekly averages
