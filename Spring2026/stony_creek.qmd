...
line_dopct_spring <- ggplot(do_pct_spring)+
  ...
  labs(title = "Mean Spring Dissolved Oxygen 
       Percent Saturation Level by Year")
...
line_dopct_summer <- ggplot(do_pct_summer)+
  geom_line(aes(year, mean_do_pct))+
  labs(title = "Mean Summer Dissolved Oxygen 
       Percent Saturation Level by Year")
...
line_dopct_winter <- ggplot(do_pct_winter)+
  geom_line(aes(year, mean_do_pct))+
  labs(title = "Mean Winter Dissolved Oxygen 
                Percent Saturation Level by Year")
...
seasons_do_pct <- mean_do_pct|> filter(!is.na(season))|>
  ...
  scale_color_viridis_d()+
  labs(title = "Mean Seasonal Dissolved Oxygen
       Percent Saturation Level by Year")
...
line_domgl_spring <- ggplot(do_mgl_spring)+
  ...
  labs(title = "Mean Spring Dissolved Oxygen oxygen concentration 
...
line_domgl_fall <- ggplot(do_mgl_fall)+
  geom_line(aes(year, mean_do_mgl))+
  labs(title = "Mean Fall Dissolved Oxygen oxygen concentration 
       measured in milligrams per Liter (mg/L) by Year")
...
line_domgl_summer <- ggplot(do_mgl_summer)+
  geom_line(aes(year, mean_do_mgl))+
  labs(title = "Mean SummerDissolved Oxygen oxygen concentration 
       measured in milligrams per Liter (mg/L) by Year")
...
seasons_do_mgl <- mean_do_mgl|> filter(!is.na(season))|>
  ...
  scale_color_viridis_d()+
  labs(title = "Mean Seasonal Dissolved Oxygen oxygen concentration 
       measured in milligrams per Liter (mg/L) by Year")
...
line_spcond_summer <- ggplot(sp_cond_summer)+
  geom_line(aes(year, mean_sp_cond))+
  labs(title = "Mean Summer Dissolved Oxygen oxygen concentration 
       measured in milligrams per Liter (mg/L) by Year")
...
line_chloro_winter <- ggplot(chloro_winter)+
  geom_line(aes(year, mean_chloro))+
  labs(title = "Mean Winter Dissolved Oxygen oxygen concentration 
       measured in milligrams per Liter (mg/L) by Year")
